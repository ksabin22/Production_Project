        ...
        <script>
            ...
            function initTable() {
                table = $('#historyTable').DataTable({
                    ...
                    serverSide: false,
                    ajax: {
                        url: '<?php echo e(route('device.history.data')); ?>',
                        dataSrc: 'data',
                        data: d => {
...
<?php /**PATH /Users/sabinkhanal/Desktop/Production_Project/water-tank-app 3/resources/views/device_history.blade.php ENDPATH**/ ?>