  ...
  <script>
    ...
    function initTable(){
      table = $('#historyTable').DataTable({
        ...
        serverSide: false,
        ajax: {
          url: '<?php echo e(route("sensor.history.data")); ?>',
          dataSrc: 'data',
          data: d => { d.days = $('#rangeSelect').val(); }
        },
        columns: [
          { data: 'reading_at' },
          { data: 'oled', render: d => d === 0 ? 'On'  : 'Off' },
          { data: 'pump', render: d => d === 0 ? 'On'  : 'Off' },
          { data: 'tds', render: d => d === 0 ? 'On'  : 'Off' },
          { data: 'temp', render: d => d === 0 ? 'On'  : 'Off' },
          { data: 'ultrasonic',render: d => d === 0 ? 'On'  : 'Off' },
          { data: 'mode' },
        ],
...
<?php /**PATH /Users/sameer/Desktop/water-tank-app/resources/views/sensor_history.blade.php ENDPATH**/ ?>