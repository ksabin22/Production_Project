        ...
        <div class="container">
            ...
            <form method="POST" action="<?php echo e(route('password.store')); ?>" novalidate>
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="<?php echo e(old('email', $request->email)); ?>"
...
<?php /**PATH /Users/sabinkhanal/Desktop/Production_Project/water-tank-app 3/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>