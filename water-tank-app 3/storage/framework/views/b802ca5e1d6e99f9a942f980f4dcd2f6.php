...
<html lang="en">
    ...
    <head>
        ...
        <title>Login - Water Tank Management System</title>
    ...
    <body data-theme="light">
        ...
        <div class="container">
            ...
            <?php if(session('status')): ?>
                <p style="color: green; font-size: 0.9rem;"><?php echo e(session('status')); ?></p>
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('login')); ?>" novalidate>
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="link" href="<?php echo e(route('password.request')); ?>">Forgot your password?</a>
                <?php endif; ?>
            </form>
        </div>
        <script>
...
<?php /**PATH /Users/sabinkhanal/Desktop/Production_Project/water-tank-app 3/resources/views/auth/login.blade.php ENDPATH**/ ?>