    ...
    <body data-theme="light">
        ...
        <script>
            ...
            function initChart(data) {
                ...
                const temps = data.map(d => d.water_level);
            ...
            function initTable() {
                table = $('#historyTable').DataTable({
                    ...
                    serverSide: false,
                    ajax: {
                        url: '<?php echo e(route('water.history.data')); ?>',
                        dataSrc: 'data',
                        data: d => {
...
<?php /**PATH /Users/sabinkhanal/Desktop/Production_Project/water-tank-app 3/resources/views/water_level.blade.php ENDPATH**/ ?>