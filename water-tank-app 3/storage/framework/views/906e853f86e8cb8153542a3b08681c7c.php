...
<html lang="en">
    ...
    <head>
        ...
        <title>Water Temperature History</title>
        ...
        <script>
            ...
            function initTable() {
                table = $('#historyTable').DataTable({
                    ...
                    serverSide: false,
                    ajax: {
                        url: '<?php echo e(route('temperature.history.data')); ?>',
                        dataSrc: 'data',
                        data: d => {
                            d.days = $('#rangeSelect').val();
                        }
                    },
                    columns: [{
                            data: 'reading_at'
...
<?php /**PATH /Users/sabinkhanal/Desktop/Production_Project/water-tank-app 3/resources/views/temperature_history.blade.php ENDPATH**/ ?>