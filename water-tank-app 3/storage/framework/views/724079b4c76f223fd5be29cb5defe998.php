        ...
        <header>
            ...
            <div style="display: flex; align-items: center;">
                ...
                <div class="user-dropdown">
                    <span id="user-name"><?php echo e(Auth::user()->name); ?></span>
                ...
                <form method="POST" action="<?php echo e(route('profile.update')); ?>">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" pattern="[A-Za-z ]+"
                            title="Only letters and spaces" value="<?php echo e(old('name', $user->name)); ?>" required />
...
<?php /**PATH /Users/sabinkhanal/Desktop/Production_Project/water-tank-app 3/resources/views/profile/edit.blade.php ENDPATH**/ ?>