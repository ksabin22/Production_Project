    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            passwordField.addEventListener('input', () => {
                ...
                passwordError.textContent = strong ? '' : 'Must include upper, lower, number, symbol, and be 8+ characters';
            });

            confirmPasswordField.addEventListener('input', () => {
                const match = confirmPasswordField.value === passwordField.value;
                confirmPasswordField.style.borderColor = match ? 'var(--success-color)' : 'var(--error-color)';
